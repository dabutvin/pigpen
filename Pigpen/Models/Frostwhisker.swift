...
extension PuzzleLevel {
    ...
    /// flipped out on the ice off its upper flank.
    ///
    /// The shore question, on the longest bank the tundra has: the ridge is the dominant free
    /// wall and the whole field is which stretch of it to use. The school says the upper
    ...
    /// lean its whole upper run, and hold 27 tiles and the same school, which is 42 — the fish
