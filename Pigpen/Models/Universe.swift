...
extension Universe {
    /// The map the game ships: the meadow, the thicket and the mountain to play, and nine
    /// more worlds standing out past them as silhouettes — a boss apiece, waiting to be
    /// built.
