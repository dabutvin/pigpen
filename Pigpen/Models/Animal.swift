...
///
/// The pig is on every map. The deer turns up on the meadow's last one, where the same
/// budget has to hold two animals instead of one — together in a single pen or apart in
/// two, but both of them, or the level is lost.
