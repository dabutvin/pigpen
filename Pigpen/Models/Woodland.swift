...
extension PuzzleLevel {
    ...
    /// the west and turns east along the south, and the ground it leaves opens to the north and
    /// the east with nothing on those two sides but the rim. Nine pieces squared off round the
    /// pig hold 20 tiles; the same nine cut as a staircase across the north-east corner hold 27,
