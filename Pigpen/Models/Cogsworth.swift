...
extension PuzzleLevel {
    /// The cut runs the whole depth of the world down the west side of the gasworks and turns
    /// east along the foot of it, which hands over the west wall and most of the south one for
    /// nothing. Nine pieces squared off beside it hold 18 tiles; the same nine run along the
    /// north and then stepped away south-east hold 26, which is every tile the yard has in it.
    ///
