...
One channel, cut at the ebb. It comes in off the north rim, turns at the third row and runs the whole
...
standing on its own above the bank. Capping the pen off flat below it would have cost five pieces;
going round it costs five as well, and comes back with a tile and five points more. Which is 35.
...
The second clam is pegged on the western rim four rows above the inlet: on her own ground this time,
...
The beds: a strand down the whole western rim, and a channel down the north-east that turns and runs
...
where the tidy wall stopped, to take the clam standing above the coast; then out across the open flats
...
The second clam is four tiles east of the chevron's line, and there is no version of this pen that
...
the crab, his pool and 41 tiles of ground, with the clam south of him inside it and the one at her own
...
reach them is the crab — so a player who sees him get there has already lost.
