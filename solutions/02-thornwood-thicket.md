...
The second world, solved the same way and drawn the same way. A mushroom takes the meadow's
apple and a wilted flower its skull, so an `a` below is a mushroom worth five tiles to shut in, and
an `x` a wilted flower worth five fewer that no piece will build on — exactly as before. The thicket
...
Water on every side but the mouth at the bottom, and a mushroom lying out beyond each corner
of it. Four pieces plug the mouth and hold the pool's 16 tiles; squaring off below it with
all seven holds 21 and still reaches neither mushroom.

Seven pieces lean the wall out to the east instead: 24 tiles and the mushroom on that side,
which is 29. The mushroom to the west is the trap — the pen cannot have both, and a wall that
...
mushroom it was going to hold anyway — the first windfall that costs nothing to take.
...
Seven pools set round a clearing, no two of them touching, and a mushroom out past the
...
The mushroom is the decoy. Breaking the ring to reach it gives up more ground than five points
...
The pen bends south into a long tongue to gather both mushrooms, which are worth more than the
...
Both mushrooms shut in, and the wilted flower taken in and paid for rather than walled around —
...
Cut to the shape of the mere, the pen gathers its three mushrooms on the way round and leaves
the wilted flower on the outside.
...
tile: 28 tiles and three mushrooms, 43, against a squared-off 36 — a pair of blocks nudged out
over the mushrooms their walls wanted picks up all three of those as well.

It asks for 21 of the 24 stars below it before it opens.

---

[← Mudlark Meadow](01-mudlark-meadow.md) · [Index](README.md) · [Emberpeak →](03-emberpeak.md)
