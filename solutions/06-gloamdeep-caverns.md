...
The sixth world, solved the same way and drawn the same way. A diamond takes the meadow's apple
and a boulder its skull, so an `a` below is a diamond worth five tiles to shut in, and an `x` a
...
trash cans, twelve wells — and down here there is one body of it at most on any board, and it comes in
...
There is a diamond on every board, because a diamond is the only light in the Gloamdeep.

| # | Level | Pieces | Ground held | In the pen | Score | Squared off |
|---|---|---|---|---|---|---|
| 1 | Sinter Basin | 12 | 22 | 2 diamonds | 32 | 21 |
| 2 | Dripstone Shelf | 11 | 26 | 2 diamonds | 36 | 23 |
| 3 | Stillwater Neck | 11 | 26 | 2 diamonds, 1 boulder | 31 | 19 |
| 4 | The Blind Grike | 19 | 36 | 2 diamonds, 1 boulder | 41 | 25 |
| 5 | Glowworm Reach | 11 | 21 | 1 diamond | 26 | 15 |
| 6 | Rimstone Corner | 9 | 34 | 2 diamonds | 44 | 23 |
| 7 | Boulder Chamber | 15 | 44 | 2 diamonds, 2 boulders | 44 | 23 |
| 8 | Great Gallery | 19 | 58 | 2 diamonds, 1 boulder | 63 | 42 |
| 9 | The Roost | 20 | 35 | 3 diamonds, 1 boulder | 45 | 23 |
...
straight down off the belly as a rectangle hold 16 tiles and one diamond, which is 21 and what the
board hands over. The same twelve hung under the belly as a lozenge — stepping out west and east,
then closing again on the diagonal — hold 22 tiles and both diamonds, which is 32.
...
in again. Twenty-six tiles and both diamonds, which is 36. A diagonal wall closes two tiles a piece
...
squared off north of the water hold 14 tiles, both diamonds and the boulder, or 19, because a wall
...
26 and two diamonds less one boulder, or 31. The eight tiles of free bank that piece bought are
worth that twice over, which is a sum rather than a sight. One of those diamonds lies out past the
...
a diamond hold 36 tiles, both diamonds and the boulder they cannot avoid swallowing on the way,
...
Three diamonds, and not one of them on the line the tidy pen wants. The river steps in off the roof
at the north-west and away south-east, and the best block eleven pieces can hang under it holds 15
tiles and no diamond at all — there is no rectangle on this board that reaches any of the three, and
no piece will lie on one to sweep it up in passing either.

So the whole field is which one to go out for, on the tightest budget in the caverns. The diamond
...
it pinches down to a single tile: 21 tiles and that diamond, which is 26.
...
Nine pieces laid as a right angle are driven south of its line and hold 18 tiles and ONE diamond,
...
south dam, stepping around the boulder on the way past — hold 34 tiles and both diamonds: 44. That
...
Fifteen pieces squared off in the long chamber beside the river hold 32 tiles, a diamond and two
boulders, which comes back to 27. The same fifteen run round
as a diamond hold 44 tiles, both diamonds and two of the three boulders, which comes back to 44 —
...
three diamonds, one boulder and nineteen pieces. It holds the third biggest pen in the game, at 58
tiles, behind Wide Reaches and the dunes' Great Erg.

Nineteen pieces squared off down the west of the gallery hold 42 tiles, with two diamonds and a
boulder in them, which is 47. The same nineteen laid along the river and closed round the south
as a staircase hold 58 tiles, two diamonds and that same boulder: 63. The third diamond lies out east
...
the south end of the river with two diamonds in it, and gives the pig 21 tiles of the wide floor
north-east of the water with the third diamond and a boulder it cannot get out of swallowing: 45.

It asks for 21 of the 24 stars below it before it opens.

---

[← Starfall Reaches](05-starfall-reaches.md) · [Index](README.md) · [Lantern Carnival →](07-lantern-carnival.md)
