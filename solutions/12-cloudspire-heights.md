...
What the heights do differently is that every `~` below is **not water at all**: it is open sky
between the fields, and a long way down. It walls a pen exactly as a river does, which is all
the board ever asks of it — and the shape of it is the world's own idea: **one sky.** Every
board's is a single body, it laps all four rims of the map, and somewhere it is open enough to
hold a two-by-two of nothing but air. No mere sitting inside its banks, no scatter of wells, no
braid running thin.
...
One field has no sky on it at all: The Long Way Down, the one field back on the ground, where
every tile is bought.
...
One long cloudbank across the whole north and nothing else, its underside broken by two mud
...
The heights' boss, the twelfth rule the game has, and the last one it will ever add: the eagle
is never fenced and never held — his perch is a hole the wall goes round — and no tile of the
pig's pen may stand in his line of sight, which runs four ways from that perch, straight along
his row and his column, over turf and open sky alike. Only a fence breaks it.

His pinnacle is ringed by sky on every side, so no wall of any pen can ever stand next to him.
What can is a piece standing on its own: two stepping stones sit in his west and south rays,
each a single tile of ground adrift in the air, and a fence planted on either belongs to no pen
at all. It holds nothing, it shuts nothing, it puts out an eye. No other board in the game has a
use for such a piece.

The answers eleven worlds have taught are turned down one after the other. Lean the north
approach on the free sky wall and the board sends the whole pen back — those tiles are in his
west ray with nothing between. Take the east fields without blinding the south ray and the
causeway is spotted the same way. The tidy answer that satisfies the rule hides in the pocket
below the neck, out of both rays, and that is three pieces for 15.
