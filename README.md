...
| `screenshots.yml` | PR to main | Build, wake a simulator, capture the title screen, the tutorial, the universe map, both world trails, four boards, the settings sheet, a daily board and its archive and all fourteen shots of the three cut scenes in light + dark, post/update a PR comment |
